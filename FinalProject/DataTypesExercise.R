...
## Vector 
## one dimensional collection of nums (e.g., row or column)
...
## Matrix 
## higher level dimensional but one datatype
...
## Data Frame ==============================================
## this can have variables of different types (e.g., spreadsheet)
